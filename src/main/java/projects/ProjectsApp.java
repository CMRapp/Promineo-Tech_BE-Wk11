 ...
 * 
 * NOTE: 11/6/22 - Project on my system corrupted. Had to use provided homework solution for week 9 to restore progress
 * 
 * @author PromineoandCMRapp
 *
 */
...
private void selectProject() {
	  ...
	  /* This will throw an exception if an invalid project is selected. */
